...
export function ClaimOfferPopup({
  open,
  onOpenChange,
}: {
  open: boolean;
        ...
        <>
            <div className="flex flex-col gap-3">
              ...
              <DialogTitle className="font-['Cormorant_Garamond',serif] text-[32px] font-bold leading-[1.15] text-[#f1ece0]">
                {currentOffer.popupTitle}
              </DialogTitle>
              <div className="flex items-baseline gap-3 flex-wrap">
                <span
                  className="relative font-['Cormorant_Garamond',serif] text-2xl font-bold text-[#a9b8b1] leading-none after:content-[''] after:absolute after:-left-[5px] after:-right-[5px] after:top-1/2 after:h-[2px] after:bg-[#6f7f78] after:-translate-y-1/2"
                >
                  ${currentOffer.value}
                </span>
                ...
                <span className="text-sm text-[#b9c7c0]">
                  {currentOffer.popupSubcopy}
                </span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-[14px]">
              ...
              <input type="hidden" name="lead_source" value={currentOffer.leadSource} />
              <input type="hidden" name="_subject" value={currentOffer.emailSubject} />
              ...
              >
                {submitting ? "Submitting..." : "Claim Trim Restoration"}
              </button>
